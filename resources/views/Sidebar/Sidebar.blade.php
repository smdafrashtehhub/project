    ...
    <div style="direction: rtl">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <form action="{{route('users.edit',['id'=>auth()->user()->id])}}" method="get">
                                <button type="submit"><i class="fas fa-user-edit"></i>
                                    <p>ویرایش پروفایل</p></button>
                            </form>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endif
                @if(auth()->user()->role == 'admin' || (auth()->user()->role == 'seller' && auth()->user()->status == 'confirmation'))
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link">
